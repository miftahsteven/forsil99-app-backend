 ...
 */
export async function optimizeImageBase64(dataUrlOrBuffer, options = {}) {
    try {
        let inputBuffer;
 ...
 */
export async function optimizePostMedia(media = []) {
 ...
 */
export async function optimizeMemoryMeta(memoryMeta) {
